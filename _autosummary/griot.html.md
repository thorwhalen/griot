...
* **Return type:**
  [`Dossier`](griot.dossier.html.md#griot.dossier.Dossier)
...
* **Return type:**
  [`Draft`](griot.writers.html.md#griot.writers.Draft)
...
* **Return type:**
  [`Writer`](griot.writers.html.md#griot.writers.Writer)
...
* **Return type:**
  [`Quote`](griot.writers.html.md#griot.writers.Quote)
...
* **Return type:**
  [`GateReport`](griot.gates.html.md#griot.gates.GateReport)
...
| [`dossier`](griot.dossier.html.md#module-griot.dossier)   | The dossier — what research found, in one record the writer reads.        |
|---------------------------------------------------------------------------------|---------------------------------------------------------------------------|
| [`gates`](griot.gates.html.md#module-griot.gates)       | Gates — what a draft must pass before it is voiced, and what it failed.   |
| [`style`](griot.style.html.md#module-griot.style)       | The style library — the voice guide, the checklist, twenty critic voices. |
| [`tools`](griot.tools.html.md#module-griot.tools)       | The SSOT verbs — plain functions, JSON-able in, JSON-able out.            |
| [`writers`](griot.writers.html.md#module-griot.writers)   | Writers — reusable, parametrized authors of spoken commentary.            |
